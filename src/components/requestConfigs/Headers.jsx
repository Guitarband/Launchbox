...
function Headers({currentHeaders, setCurrentHeaders, setRestApis, selectedCollection, selectedApi}) {
  return (
	<div className="requestParameters">
		...
		{
			currentHeaders.map((entry, index) => {
				return (
							...
							(e) => {
								...
								setCurrentHeaders((prev) => {
									...
									setRestApis((prev) => {
										...
										newApis[selectedCollection].endpoints[selectedApi].headers = entries;
										return {apis: newApis};
									})
									return entries;
								})
		...
		setCurrentHeaders((prev) => {
			...
			setRestApis((prev) => {
				const newApis = [...prev.apis];
				newApis[selectedCollection].endpoints[selectedApi].unsaved = true;
				newApis[selectedCollection].endpoints[selectedApi].headers = newEntries;
				return {apis: newApis};
			})
			return newEntries;
		})
